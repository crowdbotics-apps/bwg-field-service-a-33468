...
## Project Structure
    ...
    ├── bwg_field_service_a_33468  # Django project configurations
...
1. Clone this repo and `cd bwg_field_service_a_33468`
...
2. Clone this repo and `cd bwg_field_service_a_33468`
